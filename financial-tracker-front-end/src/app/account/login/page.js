  ...
  return (
    <Layout>
      <div className="max-w-sm rounded overflow-hidden ">
        ...
        <div className="shadow-lg px-6 py-4 flex flex-col items-center">
          <div className="font-bold text-xl align-middle text-white">Login</div>
          <div className="flex-col">
            <form onSubmit={handleSubmit(onSubmit)}>
              ...
              <div className="flex flex-row items-center align-middle justify-around my-4">
                <div>
                  <button
                    disabled={formState.isSubmitting}
                    className="bg-tangerine inline-block bg-gray-200 w-full rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2"
                  >
                ...
                <div>
                  <button className="bg-tangerine inline-block bg-gray-200 rounded-full px-3 py-1 text-sm w-full font-semibold text-gray-700 mr-2 mb-2">
